...
# (Project 1: Importing and Data Cleaning in Excel - Sample)(https://github.com/akcfraser/Fraser_DA_Portfolio/blob/main/Montgomery_Fleet_Equipment_Inventory_FA_PART_1_END.xlsx)
